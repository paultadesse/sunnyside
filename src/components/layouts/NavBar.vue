  ...
  >
    <div class="flex justify-between items-center p-10 text-white">
      ...
      <div class="hidden md:flex">
        <div class="flex items-center space-x-12 font-readexpro">
          <div>
            <a href="#">About</a>
          </div>
          <div>
          ...
          <div class="bg-white px-6 py-2 rounded-full text-black">
            <a href="#">Contact</a>
          </div>
        </div>
      </div>
      <div class="relative md:hidden">
        <button class="block" @click="humburgerClicked = !humburgerClicked">
        ...
        <div v-bind:class="{ hidden: !humburgerClicked }">
          <!-- the rotated triangle -->
          <div class="absolute right-1 w-11 overflow-hidden inline-block">
            <div
          ...
          >
            ...
            <div class="bg-myyellow px-6 py-2 rounded-full text-black">
              <a href="#">Contact</a>
            </div>
          </div>
        </div>
